				...
				<img src="../images/team/<?= $produto->produto_imagem ?>" alt="" class="img-responsive" /> 
					...
					<p>Envie seus dados, data e horário para verificarmos a disponibilidade, para melhor atendê-lo!</p>
									...
									<form class="cmxform" method="post" action="confirmaragenda.php" id="contactfrm" role="form" name="dados" onSubmit="return enviardados();">
											...
											<input type="hidden" name="servico_descricao" style="text-transform:uppercase" value="<?= stripslashes($produto->produto_nome) ?>">
											<input type="hidden" name="servico_status" value="0">
											<input type="hidden" name="servico_pagina" style="text-transform:uppercase" value="<?= stripslashes($produto->produto_id) ?>">
