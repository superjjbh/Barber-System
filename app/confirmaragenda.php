       ...
       <div class="pages_maincontent">
			<div class="page_content">
			  ...
			  <div><h3>Confira os dados do seu agendamento:</h3></div>
				...
				<b>Serviço Solicitado:</b> <?= stripslashes($_POST['servico_descricao']) ?> - R$ <?= stripslashes($_POST['servico_valor']) ?></br> 
