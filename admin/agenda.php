								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#<?= stripslashes($service->servico_id) ?>">
													...
													<img src="./images/confirmado.png" alt="CONFIRMADO" />  Data: <?= stripslashes($service->servico_data) ?> | Cliente: <?= stripslashes($service->servico_nome) ?> | Horário: <?= stripslashes($service->servico_horario) ?>
													<?php endif; ?>
													<?php if (stripslashes($service->servico_status) == 2): ?>
													<img src="./images/inicio.png" alt="ATENDIDO" />  Data: <?= stripslashes($service->servico_data) ?> | Cliente: <?= stripslashes($service->servico_nome) ?> | Horário: <?= stripslashes($service->servico_horario) ?>
													<?php endif; ?>
													<?php if (stripslashes($service->servico_status) == 0): ?>
													<img src="./images/erro.png" alt="PENDENTE" />  Data: <?= stripslashes($service->servico_data) ?> | Cliente: <?= stripslashes($service->servico_nome) ?> | Horário: <?= stripslashes($service->servico_horario) ?>
													<?php endif; ?>
										</a>
									</h4>
								</div>
